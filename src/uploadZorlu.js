...
class UploadZorluScreen extends Component {
    constructor(props) {
        super(props);
        this.state = {
            loading: false,
    ...
    async uploadToServer(data) {
        ...
        try {
            blobcnv(data, function (error, img) {
                ...
                axios.post("https://www.tesvik-sgk.com/signal/api/image/uploadZorlu", { img }).then((res) => {
                    console.log(res);
    ...
    render() {
        return (
            <div class="col">
                <div class="container">
                    <div class="card">
                        <h3>Zorlu AVM için Resim Yükle</h3>
                        <div class="drop_box">
                            <header>
...
export default UploadZorluScreen;